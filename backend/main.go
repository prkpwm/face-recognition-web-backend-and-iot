...
import (
	...
	//CRUD
	"backend/crud"
	"backend/crud/attendance"
	"backend/crud/display"
	"backend/crud/language"
	"backend/crud/member"
	"backend/crud/memberSetting"
	"backend/crud/password"
	"backend/crud/report"
	"backend/crud/scannerMode"
	"backend/crud/sound"
	"backend/libs/bcrypt"
	"backend/libs/registerFace"
